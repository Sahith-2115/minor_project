...
MODEL_SAVE_PATH = "/home/sahith/projects/minor_project_408/outputs/models/best_model.keras"
...
if __name__ == "__main__":
    ...
    X_train_mel, X_train_hand, y_train = prepare_data(
        train_df,
        is_training=True
    )
    ...
    X_val_mel, X_val_hand, y_val = prepare_data(
        val_df,
        is_training=False
    )
    ...
    history = model.fit(
        ...
        [X_train_mel, X_train_hand],
        y_train,

        validation_data=(
            [X_val_mel, X_val_hand],
            y_val
        ),
